							...
							<fieldset>
								<div class="form-group">
									<input type="email" name="email" placeholder="Yours email" class="form-control contact-email contact-error" required="required" >
									   <xsl:attribute name="placeholder" select="//captions/message_address/@caption" />
									</input>
									<span class="help-block"></span>
								</div>
							<!-- 	<div class="form-group">
									<input type="text" name="subject" class="form-control contact-subject contact-error">
								...
								<div class="contact-form__btn">
									<div class="form-captcha">
										<div class="g-recaptcha" data-sitekey="6Le-FQcUAAAAAPLakjo81XVhJ8ZRGJIwmfvyvEvn"></div>
