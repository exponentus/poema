...
/***/ function(module, exports, __webpack_require__) {
	...
	var tasks_1 = __webpack_require__(607);
	var task_1 = __webpack_require__(609);
	var task_list_1 = __webpack_require__(613);
	var task_stream_1 = __webpack_require__(615);
	var task_filter_1 = __webpack_require__(617);
	var request_1 = __webpack_require__(618);
	var user_profile_1 = __webpack_require__(620);
	var login_1 = __webpack_require__(622);
	var shared_1 = __webpack_require__(623);
	var attachments_1 = __webpack_require__(631);
	var error_message_1 = __webpack_require__(632);
	var pagination_1 = __webpack_require__(633);
	var autofocus_directive_1 = __webpack_require__(635);
	var datepicker_1 = __webpack_require__(636);
	var dropdown_1 = __webpack_require__(638);
	var tabs_1 = __webpack_require__(641);
	var switch_button_1 = __webpack_require__(644);
	var notification_1 = __webpack_require__(600);
	var markdown_1 = __webpack_require__(646);
	var pipes_1 = __webpack_require__(593);
	var app_routing_1 = __webpack_require__(659);
	var translate_service_1 = __webpack_require__(469);
	var services_1 = __webpack_require__(467);
	var store_1 = __webpack_require__(662);
	var actions_1 = __webpack_require__(462);
	var auth_guard_1 = __webpack_require__(660);
	var redirect_guard_1 = __webpack_require__(661);
	    ...
	    AppModule = __decorate([
	        core_1.NgModule({
	            declarations: [
	                ...
	                shared_1.OrganizationInputComponent, shared_1.EmployeeInputComponent, shared_1.ProjectInputComponent,
	                shared_1.TaskTypeInputComponent, shared_1.TagsInputComponent, shared_1.RequestTypeInputComponent, shared_1.TaskStatusInputComponent,
	                ...
	                pipes_1.DateFormatPipe, pipes_1.DateDurationPipe, pipes_1.TextTransformPipe, pipes_1.LocalizedNamePipe
	            ],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $$observable = __webpack_require__(84);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isFunction_1 = __webpack_require__(75);
	var iterator_1 = __webpack_require__(382);
	var errorObject_1 = __webpack_require__(80);
	/**
	 * We need this JSDoc comment for affecting ESDoc.
	 * @extends {Ignored}
	 * @hide true
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmptyObservable_1 = __webpack_require__(368);
	/**
	 * We need this JSDoc comment for affecting ESDoc.
	 * @extends {Ignored}
	 * @hide true
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProjectService = (function () {
	    ...
	    ProjectService.prototype.getProjectStatusTypes = function () {
	        return this.translate.get(['draft', 'processing', 'completed']).map(function (t) { return [
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppService = (function () {
	    ...
	    AppService.prototype.updateUserProfile = function (userForm) {
	        return this.http.post('/Staff/p?id=userprofile', utils_1.serializeObj(userForm), { headers: HEADERS })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProjectsComponent = (function () {
	    ...
	    ProjectsComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [store_1.Store, router_1.Router, environment_actions_1.EnvironmentActions, project_actions_1.ProjectActions, project_service_1.ProjectService, staff_service_1.StaffService])
	    ], ProjectsComponent);
	...
	var ProjectComponent = (function () {
	    ...
	    ProjectComponent = __decorate([
	        core_1.Component({
	            ...
	            pipes: [pipes_1.KeysPipe, pipes_1.ValuesPipe]
	        }), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var date_duration_pipe_1 = __webpack_require__(595);
	exports.DateDurationPipe = date_duration_pipe_1.DateDurationPipe;
	var text_transform_pipe_1 = __webpack_require__(596);
	exports.TextTransformPipe = text_transform_pipe_1.TextTransformPipe;
	var values_pipe_1 = __webpack_require__(597);
	exports.ValuesPipe = values_pipe_1.ValuesPipe;
	var keys_pipe_1 = __webpack_require__(598);
	exports.KeysPipe = keys_pipe_1.KeysPipe;
	var localized_name_pipe_1 = __webpack_require__(599);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(11);
	var notification_1 = __webpack_require__(602);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(11);
	var notification_service_1 = __webpack_require__(601);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TasksComponent = (function () {
	    ...
	    TasksComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [store_1.Store, router_1.Router, router_1.ActivatedRoute, environment_actions_1.EnvironmentActions, actions_1.TaskActions, task_service_1.TaskService])
	    ], TasksComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ng2_translate_1 = __webpack_require__(361);
	var pipes_1 = __webpack_require__(593);
	var comments_1 = __webpack_require__(610);
	var notification_1 = __webpack_require__(600);
	var actions_1 = __webpack_require__(462);
	var services_1 = __webpack_require__(467);
	var models_1 = __webpack_require__(574);
	var TaskComponent = (function () {
	    ...
	    TaskComponent.prototype.toggleShowRequests = function () {
	    ...
	    TaskComponent.prototype.cancelTask = function () {
	        var _this = this;
	        var noty = this.notifyService.process(this.translate.instant('wait_while_process')).show();
	        this.taskService.cancelTask(this.task).subscribe(function (response) {
	            noty.set({ type: 'success', message: response.message }).remove(1500);
	            _this.close();
	        }, function (error) {
	            noty.remove();
	    ...
	    TaskComponent.prototype.acceptRequest = function (request) {
	        ...
	        if (request.requestType.name == 'prolong') {
	            this.store.dispatch({
	                type: actions_1.TaskActions.TASK_REQUEST_ACCEPTANCE,
	                payload: {
	                    task: this.task,
	                    request: request
	                }
	    ...
	    TaskComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [store_1.Store, router_1.Router, router_1.ActivatedRoute, ng2_translate_1.TranslateService, actions_1.TaskActions, services_1.TaskService, notification_1.NotificationService])
	    ], TaskComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(11);
	var comment_1 = __webpack_require__(611);
	var models_1 = __webpack_require__(574);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RequestComponent = (function () {
	    ...
	    RequestComponent.prototype.doAccept = function (request) {
	        var _this = this;
	        this.taskService.doRequestResolution(request, 'ACCEPT', { dueDate: this.dueDate }).subscribe(function (action) {
	            _this.store.dispatch(action);
	            _this.close();
	        });
	    };
	    RequestComponent.prototype.doDecline = function (request) {
	        var _this = this;
	        this.taskService.doRequestResolution(request, 'DECLINE').subscribe(function (action) {
	            _this.close();
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RequestTypeInputComponent = (function () {
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', models_1.RequestType)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TaskStatusInputComponent = TaskStatusInputComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(11);
	var Pikaday = __webpack_require__(637);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var dropdown_component_1 = __webpack_require__(639);
	var dropdown_toggle_component_1 = __webpack_require__(640);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var tabs_1 = __webpack_require__(642);
	var tab_1 = __webpack_require__(643);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(11);
	var marked = __webpack_require__(648);
	var toMarkdown = __webpack_require__(649);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = [
	    ...
	    { path: 'projects/:projectId/tasks', component: tasks_1.TasksComponent, canActivate: [auth_guard_1.AuthGuard] },
	    ...
	    { path: 'requests/:requestId', component: request_1.RequestComponent, canActivate: [auth_guard_1.AuthGuard] },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RedirectGuard = (function () {
	    ...
	    RedirectGuard.prototype.canActivate = function (next, state) {
	        if (state.url === '/') {
	            var s = 'id=project-form&projectId=';
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var compose_1 = __webpack_require__(664);
	var store_1 = __webpack_require__(388);
	var ngrx_store_logger_1 = __webpack_require__(665);
	var environment_reducer_1 = __webpack_require__(666);
	var authed_reducer_1 = __webpack_require__(667);
	var projects_reducer_1 = __webpack_require__(668);
	var tasks_reducer_1 = __webpack_require__(669);
	var task_reducer_1 = __webpack_require__(670);
	var staff_reducer_1 = __webpack_require__(671);
	var reference_reducer_1 = __webpack_require__(672);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.environmentReducer = function (state, _a) {
	    ...
	    switch (type) {
	        case environment_actions_1.EnvironmentActions.SEARCH:
	            return Object.assign({}, state, {
	                keyWord: payload.keyWord
	            });
	        case environment_actions_1.EnvironmentActions.RESET_SEARCH:
	            return Object.assign({}, state, {
	                keyWord: ''
	            });
	        ...
	        case environment_actions_1.EnvironmentActions.SET_REDIRECT_URL:
	            return Object.assign({}, state, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.tasksReducer = function (state, _a) {
	    ...
	    switch (type) {
	        ...
	        case actions_1.TaskActions.SET_FILTER:
	            return Object.assign({}, state, {
	                filter: payload
	            });
	        default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.taskReducer = function (state, _a) {
	    ...
	    switch (type) {
	        ...
	        case actions_1.TaskActions.TASK_REQUEST_ACCEPTANCE:
	            return Object.assign({}, state, {
	                task: payload.task,
