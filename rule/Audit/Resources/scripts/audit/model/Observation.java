...
@Entity
@Table(name = "construction__observations")
public class Observation extends SecureHierarchicalEntity {
    ...
    @JoinTable(name = "observation_tags")
    private List<Tag> tags;

    @ManyToMany(fetch = FetchType.EAGER)
    @JoinTable(name = "observation_observers")
    ...
    @JoinTable(name = "observation_attachments", joinColumns = {
