...
public class Observation extends EmbeddedSecureHierarchicalEntity {
	...
	@JoinTable(name = "audit__constr__observation_attachments", joinColumns = {
			@JoinColumn(name = "observation_id") }, inverseJoinColumns = { @JoinColumn(name = "attachment_id") }, indexes = {
	...
	public String getURL() {
		return AppConst.BASE_URL + "observations/" + getIdentifier();
	}
}
