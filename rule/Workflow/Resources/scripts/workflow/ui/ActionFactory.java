...
public class ActionFactory extends ConventionalActionFactory {
    ...
    public Action newIncoming = new Action(ActionType.LINK).caption("new_incoming").url(ModuleConst.BASE_URL + "incomings/new");
    public Action newOutgoing = new Action(ActionType.LINK).caption("new_outgoing").url(ModuleConst.BASE_URL + "outgoings/new");
    public Action newOfficeMemo = new Action(ActionType.LINK).caption("new_internal").url(ModuleConst.BASE_URL + "office-memos/new");
