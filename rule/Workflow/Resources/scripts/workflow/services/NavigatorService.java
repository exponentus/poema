...
public class NavigatorService extends RestProvider {
    ...
    public Response getNav() {
        ...
        co.addEntry(new _OutlineEntry("office_memo_plural", "", "fa fa-pencil-square-o", "office-memos", "office-memos/projects"));
        co.addEntry(new _OutlineEntry("application_for_vehicle", "", "fa fa-car", "applications_for_vehicle_prj",
