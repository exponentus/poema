...
public class IncomingViewEntry {
    ...
    public IncomingViewEntry(UUID id, String regNumber, Date appliedRegDate, String senderOrgName, String senderRegNumber, Date senderAppliedRegDate, String addresseeEmpName, DocumentLanguage docLanguage, DocumentType docType, DocumentSubject docSubject, String body, Long attachmentCount) {
        this.id = id;
