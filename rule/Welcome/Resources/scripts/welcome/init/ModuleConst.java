...
public class ModuleConst extends DefaultAppConst {
	...
	public static String NAME_POR = "Bem vinda";
	public static String NAME_BUL = "Добре дошли";
	public static String NAME_KAZ = "Қош келдіңіздер";
	public static String DEFAULT_PAGE = "index";
	public static String CAPTCHA_CODE = "6LfmJxEUAAAAAHogCrEigQvrhs9k8VljykxQUj3U";
