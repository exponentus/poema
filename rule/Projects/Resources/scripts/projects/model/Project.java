...
@NamedEntityGraphs({
        @NamedEntityGraph(
                name = Project.SHORT_GRAPH,
                attributeNodes = {
                        @NamedAttributeNode(value = "customer", subgraph = "customer"),
                        @NamedAttributeNode(value = "attachments", subgraph = "attachments")
                },
                subgraphs = {
                        @NamedSubgraph(name = "customer", attributeNodes = {
                                @NamedAttributeNode("id"),
                                @NamedAttributeNode("name"),
                                @NamedAttributeNode("localizedName")
                        }),
                        @NamedSubgraph(name = "attachments", attributeNodes = {
                                @NamedAttributeNode("id"),
