...
public enum TaskStatusType {
	UNKNOWN(0), DRAFT(453), WAITING(454), @Deprecated
	PROCESSED(455), @Deprecated
	FINISHED(456), PROCESSING(460), COMPLETED(461), CANCELLED(462), OPEN(463), PENDING(464), POSTPONED(465);
