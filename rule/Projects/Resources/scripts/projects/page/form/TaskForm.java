...
public class TaskForm extends _DoForm {
    ...
    public void doGET(_Session session, _WebFormData formData) {
        ...
        if (!id.isEmpty()) {
            ...
            String parentTaskId = formData.getValueSilently("parentTask");
    ...
    public void doPOST(_Session session, _WebFormData formData) {
        ...
        try {
            ...
            if (!formData.getValueSilently("observerUserIds").isEmpty()) {
                ouIds = Arrays.stream(formData.getValueSilently("observerUserIds").split(",")).map(Long::valueOf).collect(Collectors.toSet());
                for (long uid : ouIds) {
