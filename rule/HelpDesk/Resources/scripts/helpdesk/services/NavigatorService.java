	...
	public Response getNav() {
		...
		try {
			...
			for (DemandType dt : dts) {
				...
				co.addEntry(new _OutlineEntry(dt.getLocName(lang), "", icon, "demands/s/" + dt.getName(),
						"demands/s/" + dt.getName()));
			}
		...
		co.addEntry(
				new _OutlineEntry("initiative_tasks", "", "fa fa-list", "tasks/s/initiative", "tasks/s/initiative"));
		// co.addEntry(new _OutlineEntry("projects", "", "projects",
		// "projects"));
